...
func request_SampleService_SampleRPC_0(ctx context.Context, marshaler runtime.Marshaler, client SampleServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SampleRequest
	var metadata runtime.ServerMetadata

	msg, err := client.SampleRPC(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
...
func RegisterSampleServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SampleServiceClient) error {
	...
	mux.Handle("GET", pattern_SampleService_SampleRPC_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_SampleService_SampleRPC_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_SampleService_SampleRPC_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_SampleService_SampleRPC_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"samplerpc"}, ""))
)

var (
	forward_SampleService_SampleRPC_0 = runtime.ForwardResponseMessage
)
